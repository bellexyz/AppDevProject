        ...
        },
        {
            ...
            cell: row => (
                activeTable === 'verify' && row.status === 'pending verification' ? (
                    ...
                    // Conditional rendering for other tables
                    row.status !== 'banned' ?
                ...
                <Row>
                    ...
                    <Col sm={10} className="main-content mt-5">
                        ...
                        <Nav variant="underline" className="flex-row" style={{ marginLeft: '10px' }}>
                            <Nav.Item>
                                <Nav.Link style={{ color: 'white', marginLeft: '15px' }} href="#accounts" onClick={() => handleNavClick('accounts')} active={activeTable === 'accounts'}>All</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link style={{ color: 'white', marginLeft: '15px' }} href="#active" onClick={() => handleNavClick('active')} active={activeTable === 'active'}>Active Accounts</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
